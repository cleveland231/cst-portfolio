...
const Welcome = () => {
  return (
    <div className='Welcome'>
        ...
        in oil and energy. These busy environments taught me how to quickly adapt and communicate on different teams. Eventually 
        I realized that I would rather apply my intellect to the world of software development. This new trajectory has been 
